...
`acr.url` | defines the url of azure container registry| `""`
`acr.clientId` | is the client id used to access azure container registry | `""`
`acr.password` | is the client password used to access azure container registry | `""`
